...
class QuestionsRepository {
  final List<Tuple2<String, String>> phase1 = [
    ...
    Tuple2('Które z polskich miast nosiło nazwę Stalinogród?', 'Katowice'),
  ];
  final List<Tuple2<String, String>> phase2 = [
    Tuple2(
  ...
  final List<Tuple2<String, String>> phase3 = [
    Tuple2(
